...
//
//    ratio1 = (float)((point_Base[2].y - point_Base[0].y) + (point_Base[3].y - point_Base[1].y)) / 2.0;
//    ratio2 = (float)((left_down_point.y - left_upper_point.y) + (right_down_point.y - right_upper_point.y)) / 2.0;
//    adjust_Para.yScale = ratio1 / ratio2;

    ratio1 = ((float)(point_Base[1].x - point_Base[0].x)) / ((float)(right_upper_point.x - left_upper_point.x));
    ratio2 = ((float)(point_Base[3].x - point_Base[2].x)) / ((float)(right_down_point.x - left_down_point.x));
    adjust_Para.xScale = (ratio1 + ratio2) / 2.0;

    ratio1 = ((float)(point_Base[2].y - point_Base[0].y)) / ((float)(left_down_point.y - left_upper_point.y));
    ratio2 = ((float)(point_Base[3].y - point_Base[1].y)) / ((float)(right_down_point.y - right_upper_point.y));
    adjust_Para.yScale = (ratio1 + ratio2) / 2.0;


//    ratio1 = (((float)right_upper_point.x * adjust_Para.xScale - (float)point_Base[1].x)
//             + ((float)left_upper_point.x * adjust_Para.xScale - (float)point_Base[0].x)
//             + ((float)left_down_point.x * adjust_Para.xScale - (float)point_Base[2].x)
//             + ((float)right_down_point.x * adjust_Para.xScale - (float)point_Base[3].x)) / 4.0;

        ratio1 = ((float)right_down_point.x * adjust_Para.xScale - (float)point_Base[3].x);

    adjust_Para.xOffset = (int)ratio1;

//    ratio1 = (((float)right_upper_point.y * adjust_Para.yScale - (float)point_Base[1].y)
//             + ((float)left_upper_point.y * adjust_Para.yScale - (float)point_Base[0].y)
//             + ((float)left_down_point.y * adjust_Para.yScale - (float)point_Base[2].y)
//             + ((float)right_down_point.y * adjust_Para.yScale - (float)point_Base[3].y)) / 4.0;

        ratio1 = ((float)left_upper_point.y * adjust_Para.yScale - (float)point_Base[0].y);
